...
exports.config = {
   ...
   */
  license_key: '56f685bb36d1bbffdff7a77e6d19ebc111291b69',
  /**
  ...
  /**
   * Deprecated. Please use `config.attributes.enabled` instead.
   *
   * @env NEW_RELIC_CAPTURE_PARAMS
   */
  capture_params: false, // TODO: default to true in v3 and remove in v4
  /**
   * Deprecated. Please use `config.attributes.exclude` instead.
   *
  ...
  transaction_tracer: {
     ...
     * feature.
     *
     * TODO: Change this default to `false` for Agent v3.
     *
